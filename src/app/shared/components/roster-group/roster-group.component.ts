...
import { IonAccordionGroup, IonAccordion, IonLabel, IonItem } from "@ionic/angular/standalone";
...
@Component({
  ...
  standalone: true,
  imports: [IonItem, IonLabel, IonAccordion, IonAccordionGroup, CommonModule, RosterContactItemComponent],
})
